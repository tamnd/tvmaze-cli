...
// HTTP behaviour is covered in tvmaze_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "tvmaze://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("tvmaze", "about")
	if err != nil || got.String() != "tvmaze://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want tvmaze://page/about", got.String(), err)
	}
}
