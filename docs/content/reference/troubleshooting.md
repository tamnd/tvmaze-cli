...
Most of these come down to network reality or how tvmaze serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

tvmaze rate-limits like any public site. tvmaze already paces
...
Where a surface is gated, tvmaze reads a cookie or token you supply
...
`tvmaze`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what tvmaze actually did
